...
import com.chess.pieces.PieceImages;
...
public class Game {
	...
	public static void checkMate() {
		...
		King king = player ? wk : bk;

		String message = "";
		if (king.isInCheck()) {
			message = "Checkmate. " + (!player ? "White" : "Black") + " wins!";
		} else {
			message = "Stalemate!";
		}
		...
		JOptionPane.showOptionDialog(null, panel, "Game Over", JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE,
			...
			if (active.makeMove(x, y, board)) {
				...
				try {
					AudioInputStream audioInputStream = AudioSystem.getAudioInputStream(
							new File("C:\\Users\\villahermosas3\\git\\p01-individual-project-Samvae\\Sound\\move-self.wav").getAbsoluteFile());
	...
	public int showMessageForPromotion() {
		...
		return JOptionPane.showOptionDialog(null, "Choose a piece to promote to:", "Promotion",
